  ...
  <ul>
    ...
    <div class="addvertiseDiv">
        ...
        <div>
            ...
            <?php  
           $itemInfo = "SELECT ItemID, ItemName, ItemCategory, ItemCondition, PictureName, ItemPrice,UserHomeTown FROM items JOIN user USING(UserID) JOIN picture USING(ItemID) WHERE ItemCategory LIKE \"Electronics\"";
